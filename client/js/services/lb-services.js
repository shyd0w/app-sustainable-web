...
/**
 * @ngdoc object
 * @name lbServices.SusUser
 * @header lbServices.SusUser
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `SusUser` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#prototype$__findById__accessTokens
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         * Find a related item by id for accessTokens.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `SusUser` object.)
         * </em>
         */
        "prototype$__findById__accessTokens": {
          params: {
          ...
          url: urlBase + "/SusUsers/:id/accessTokens/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#prototype$__destroyById__accessTokens
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#prototype$__updateById__accessTokens
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#prototype$__get__accessTokens
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         * Queries accessTokens of SusUser.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
        ...
        "prototype$__get__accessTokens": {
          isArray: true,
          url: urlBase + "/SusUsers/:id/accessTokens",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#prototype$__create__accessTokens
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#prototype$__delete__accessTokens
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#prototype$__count__accessTokens
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         * Counts accessTokens of SusUser.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         */
        "prototype$__count__accessTokens": {
          url: urlBase + "/SusUsers/:id/accessTokens/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#create
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "create": {
          url: urlBase + "/SusUsers",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#createMany
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#upsert
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#exists
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/SusUsers/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#findById
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/SusUsers/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#find
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#findOne
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/SusUsers/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#updateAll
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/SusUsers/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#deleteById
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/SusUsers/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#prototype$updateAttributes
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#createChangeStream
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/SusUsers/change-stream",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#login
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        "login": {
          ...
          url: urlBase + "/SusUsers/login",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#logout
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        "logout": {
          ...
          url: urlBase + "/SusUsers/logout",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#confirm
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "confirm": {
          url: urlBase + "/SusUsers/confirm",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#resetPassword
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         ...
         */
        "resetPassword": {
          url: urlBase + "/SusUsers/reset",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.SusUser#getCurrent
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#updateOrCreate
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#update
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#destroyById
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#removeById
         * @methodOf lbServices.SusUser
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#getCachedCurrent
         * @methodOf lbServices.SusUser
         *
         * @description
         *
         * Get data of the currently logged user that was returned by the last
         * call to {@link lbServices.SusUser#login} or
         * {@link lbServices.SusUser#getCurrent}. Return null when there
         * is no user logged in or the data of the current user were not fetched
         * yet.
         *
         * @returns {Object} A SusUser instance.
         */
        R.getCachedCurrent = function() {
          var data = LoopBackAuth.currentUserData;
          return data ? new R(data) : null;
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#isAuthenticated
         * @methodOf lbServices.SusUser
         *
         * @returns {boolean} True if the current user is authenticated (logged in).
         */
        ...
        /**
         * @ngdoc method
         * @name lbServices.SusUser#getCurrentId
         * @methodOf lbServices.SusUser
         *
         * @returns {Object} Id of the currently logged-in user or null.
         */
    ...
    /**
    * @ngdoc property
    * @name lbServices.SusUser#modelName
    * @propertyOf lbServices.SusUser
    * @description
    * The name of the model represented by this $resource,
    * i.e. `SusUser`.
    */
